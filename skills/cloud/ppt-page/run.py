"""ppt-page skill (cloud) — HTML PPT 单页 / PPT page.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'outline'."""
    args = args or {}
    outline_value = args.get("outline")
    if not outline_value:
        return {"error": "missing outline", "provider_hint": PROVIDER_HINT}
