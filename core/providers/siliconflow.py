"""Aerie · 云栖 v9.0 — SiliconFlow provider (OpenAI-compatible).

Provides access to models hosted on SiliconFlow, e.g. google/gemma-4-26B-A4B-it.
"""
