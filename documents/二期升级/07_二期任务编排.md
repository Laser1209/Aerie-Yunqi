...
| 当前状态 | `P2-00-B01`、`P2-00-B02` Done；`P2-00-B03` Ready；G0 Open，未通过前不得开始功能实现 |
...
| W1 | P2-00-B03 | 完成追踪矩阵、ADR、所有权和风险责任人 | P2-00-B01、P2-00-B02 | ARCH / PO | CON | G0 | 无状态变更 | Ready |
...
`P2-00-B01` 与 `P2-00-B02` 已完成独立 Review；B02 的 Done 表示证据采集完成，不表示失败项已通过。当前只允许执行 `P2-00-B03`；G0 通过前仍禁止进入功能实现。后续依次执行：
...
3. `P2-00-B03`：建立需求追踪、ADR、风险责任和完整 Evidence 索引，处理或约束 B02 阻断后提交 G0 审查。
