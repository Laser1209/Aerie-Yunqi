"""algorithmic-art skill (cloud) — 算法艺术 / Algorithmic art.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'seed'."""
    args = args or {}
    seed_value = args.get("seed")
    if not seed_value:
        return {"error": "missing seed", "provider_hint": PROVIDER_HINT}
