...
| 当前状态 | `P2-00-B01` Done；`P2-00-B02` Ready；G0 Open，未通过前不得开始功能实现 |
...
| W1 | P2-00-B02 | 重采测试、性能、安全和包内容基线 | P2-00-B01 | QA / ARCH | TST, PERF, SEC | - | 无状态变更 | Ready |
...
`P2-00-B01` 已完成独立 Review。当前只允许执行 `P2-00-B02`；G0 通过前仍禁止进入功能实现。后续依次执行：
