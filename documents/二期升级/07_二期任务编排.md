...
| 公开官网 | <https://spotlight.etta.top/> |
| 当前状态 | `P2-00-B01`、`P2-00-B02`、`P2-00-B04`、`P2-00-B06`、`P2-00-B07`、`P2-00-B08` Done；`P2-00-B03` Review；`P2-00-B05` Blocked/未授权；B08 落地架构守护并关闭 `B02-BLK-005`（离线 E2E 达 `21/21`），但 G0 仍 Open（SEC/OPS/DEP/PKG 阻断未清零），未通过前不得开始功能实现 |
...
| W1 | P2-00-B08 | 落地架构守护静态风险测试并修复 Persona/Prompt Injection/Multimodal 三项剩余 E2E | P2-00-B02、P2-00-B07 | ARCH / QA | TST, SEC, BAS | - | FWD | Done |
...
- [ ] 公网官网指向 <https://spotlight.etta.top/>，下载资产与 Release 一致。
- [ ] PO 完成最终批准。
...
6. 官网公开入口统一为 <https://spotlight.etta.top/>；本地开发地址不得作为交付链接。
