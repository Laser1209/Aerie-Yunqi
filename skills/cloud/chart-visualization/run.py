"""chart-visualization skill (cloud) — 图表可视化 / Chart viz.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'data'."""
    args = args or {}
    data_value = args.get("data")
    if not data_value:
        return {"error": "missing data", "provider_hint": PROVIDER_HINT}
