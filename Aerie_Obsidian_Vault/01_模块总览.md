...
| [[modules/PersonaGenerator|人设 AI 智能生成器]] | 一句话/一段话角色描述 → 5 阶段管线自动生成完整人设并套合成熟骨架 | [[modules/PersonaGenerator#文件地图]] | 骨架 `preset_templates/yita_default.json` | LLM 任一环节失败确定性兜底，流程不中断；结果只保存不激活 | [[06_验证索引#P0-功能验证]] |

## 规划中的方案 / Planned Proposals

| 方案 | 目标 | 状态 | 入口 |
| --- | --- | --- | --- |
| [[plans/角色级对话与记忆隔离技术方案\|角色级对话与记忆隔离]] | 新增 `persona_id` 维度：对话历史、长期记忆、上下文检索、摘要分桶均按激活角色隔离；存量数据共享兼容 | proposed | [[plans/角色级对话与记忆隔离技术方案#5 核心逻辑修改点]] |
