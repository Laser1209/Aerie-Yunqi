"""json-canvas skill (cloud) — JSON Canvas / Canvas.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'diagram'."""
    args = args or {}
    diagram_value = args.get("diagram")
    if not diagram_value:
        return {"error": "missing diagram", "provider_hint": PROVIDER_HINT}
