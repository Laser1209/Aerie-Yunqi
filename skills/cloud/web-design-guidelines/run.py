"""web-design-guidelines skill (cloud) — Web 设计审查 / Web guidelines.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'html'."""
    args = args or {}
    html_value = args.get("html")
    if not html_value:
        return {"error": "missing html", "provider_hint": PROVIDER_HINT}
