...
| 当前执行状态 | `P2-00-B01`、`P2-00-B02`、`P2-00-B04` Done；`P2-00-B03` Review；56 个顶层控制行已完成追踪映射，4 项二期候选 ADR 待 PO 批准；`B02-BLK-002` 已关闭，`B02-BLK-001` 当前树已处置但历史仍 Open，其余 B02 阻断保持 Open；G0 Open，尚未进入 `P2-01` 及 G0 后功能批次 |
...
| `04_二期测试与证据索引.md` | Done with residual blockers | P2-00-B02 基线证据、P2-00-B04 当前树与扫描门修复证据及剩余阻断台账 |
