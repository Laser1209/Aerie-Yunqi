...
- [Aerie · 云栖 v10.1.1 — Agent 视角 + 自进化 + 电脑操控](#aerie-云栖-v10.1.1-agent-视角-+-自进化-+-电脑操控)

### [ENTRANCE] Entrance Zone

- [0 · 快速恢复（TL;DR）🆕](#0-快速恢复tl;dr)
  - [0.1 项目一句话](#0.1-项目一句话)
  - [0.2 当前 vs 终态](#0.2-当前-vs-终态)
  - [0.3 终态路径（v10.1.1 → v12.0.1）](#0.3-终态路径v10.1.1-v12.0.1)
  - [0.4 关键决策（v10.1.1 已确认 · 10 项）](#0.4-关键决策v10.1.1-已确认-10-项)
  - [0.5 用户 4 大幻想 → 落地映射](#0.5-用户-4-大幻想-落地映射)
  - [0.6 核心数字](#0.6-核心数字)
  - [0.7 如何使用本文档（按时间预算）](#0.7-如何使用本文档按时间预算)
  - [0.8 文档结构速查](#0.8-文档结构速查)
  - [0.9 关键文件路径速查](#0.9-关键文件路径速查)
  - [0.10 三句话总结（给未来的你）](#0.10-三句话总结给未来的你)
- [M · 项目历程 · 从 0 到 v10.1.1 🆕](#m-项目历程-从-0-到-v10.1.1)
  - [M.1 起点（2025 末 · 灵感）](#m.1-起点2025-末-灵感)
  - [M.2 启程（2026 初 · 伊塔）](#m.2-启程2026-初-伊塔)
  - [M.3 转折（2026 春 · OpenCloud 文档）](#m.3-转折2026-春-opencloud-文档)
  - [M.4 改名（2026 春末 · Aerie · 云栖）](#m.4-改名2026-春末-aerie-云栖)
  - [M.5 架构进化（2026 夏）](#m.5-架构进化2026-夏)
  - [M.6 关键心路（真实记录）](#m.6-关键心路真实记录)
  - [M.7 今天（v10.1.1 · 2026-07-17）](#m.7-今天v10.1.1-2026-07-17)
  - [M.8 未来（v11.x → v12.0.1 · 8.5 周后）](#m.8-未来v11.x-v12.0.1-8.5-周后)
  - [M.9 给未来的主人](#m.9-给未来的主人)

### [CORE] Core Technical Zone

- [A · 版本演进与合并说明](#a-版本演进与合并说明)
  - [A.1 三版关系](#a.1-三版关系)
  - [A.2 v10.1.1 合并内容](#a.2-v10.1.1-合并内容)
  - [A.3 v10.1.1 vs v10.1 vs v10.0 关键差异](#a.3-v10.1.1-vs-v10.1-vs-v10.0-关键差异)
- [B · Phase 0 · 用户原始幻想解读（OpenCloud 文档溯源）](#b-phase-0-用户原始幻想解读opencloud-文档溯源)
  - [B.1 OpenCloud 文档中的 4 个核心幻想（直接对应用户原话）](#b.1-opencloud-文档中的-4-个核心幻想直接对应用户原话)
  - [B.2 OpenCloud §13 工具系统 + §14 高权限 的具体内容](#b.2-opencloud-13-工具系统-+-14-高权限-的具体内容)
  - [B.3 OpenCloud §21 持续进化机制 的核心要求](#b.3-opencloud-21-持续进化机制-的核心要求)
  - [B.4 用户 4 大新增能力 → 技术对应](#b.4-用户-4-大新增能力-技术对应)
  - [B.5 v10.0 调研结论与 Aerie 自定位（保留 v10.0 §1 内容）](#b.5-v10.0-调研结论与-aerie-自定位保留-v10.0-1-内容)
  - [B.6 Aerie 在 GitHub 项目光谱中的位置（v10.0 调研结论）](#b.6-aerie-在-github-项目光谱中的位置v10.0-调研结论)
  - [B.7 用户&#34;以 Agent 视角调用 skills&#34;的诉求如何落地（v10.0 调研）](#b.7-用户)
- [C · Phase 1 · GitHub 项目结构化数据库（52+ 项目完整版）](#c-phase-1-github-项目结构化数据库52+-项目完整版)
  - [C.1 方向 ① · 情感表达模块（6 个项目）](#c.1-方向-情感表达模块6-个项目)
  - [C.2 方向 ② · 能力适配 / 动态性能（4 个项目）](#c.2-方向-能力适配-/-动态性能4-个项目)
  - [C.3 方向 ③ · 自调用 / 工具 / 工作流编排（8 个项目）](#c.3-方向-自调用-/-工具-/-工作流编排8-个项目)
  - [C.4 方向 ④ · 记忆 / 上下文 / 多模态 / 安全（6 个项目）](#c.4-方向-记忆-/-上下文-/-多模态-/-安全6-个项目)
  - [C.5 方向 ⑤ · 纯外部 API KEY 的&#34;薄壳 Agent&#34;（5 个项目）](#c.5-方向-纯外部-api-key-的)
  - [C.6 方向 ⑥ · 🆕 电脑操控 / Computer Use（6 个项目）](#c.6-方向-电脑操控-/-computer-use6-个项目)
  - [C.7 方向 ⑦ · 🆕 自进化 / Self-Evolution（6 个项目）](#c.7-方向-自进化-/-self-evolution6-个项目)
  - [C.8 方向 ⑧ · 🆕 文件整理 / File Organizer（5 个项目）](#c.8-方向-文件整理-/-file-organizer5-个项目)
  - [C.9 方向 ⑨ · 🆕 文档写作 / Document Writer（4 个项目）](#c.9-方向-文档写作-/-document-writer4-个项目)
  - [C.10 方向 ⑩ · 🆕 OpenClaw 完整生态（5 个项目）](#c.10-方向-openclaw-完整生态5-个项目)
- [D · Phase 2 · Aerie 5 大能力域 + Agent 视角总架构](#d-phase-2-aerie-5-大能力域-+-agent-视角总架构)
  - [D.1 5 大能力域全景](#d.1-5-大能力域全景)
  - [D.2 v10.0 已设计模块（3 个）](#d.2-v10.0-已设计模块3-个)
  - [D.3 现有 7 个核心模块的&#34;Agent 化&#34;映射（v10.0）](#d.3-现有-7-个核心模块的)
  - [D.4 v10.1+ 新增 12 个核心模块（S5 阶段）](#d.4-v10.1+-新增-12-个核心模块s5-阶段)
- [E · Phase 3 · 6 阶段落地路线图（24 里程碑 · 8.5 周 · 完整版）](#e-phase-3-6-阶段落地路线图24-里程碑-8.5-周-完整版)
  - [E.0 阶段总览](#e.0-阶段总览)
  - [E.1 S1 · 显式 Agent 抽象（1.5 周 · 4 里程碑）](#e.1-s1-显式-agent-抽象1.5-周-4-里程碑)
  - [E.2 S2 · 智能 Provider 路由（1 周 · 3 里程碑）](#e.2-s2-智能-provider-路由1-周-3-里程碑)
  - [E.3 S3 · 分层记忆 + 安全（2 周 · 5 里程碑）](#e.3-s3-分层记忆-+-安全2-周-5-里程碑)
  - [E.4 S4 · 多模态 + 自进化 L1/L2/L3（2 周 · 3 里程碑）](#e.4-s4-多模态-+-自进化-l1/l2/l32-周-3-里程碑)
  - [E.5 S5 · 🆕 自主 + 操控（2 周 · 6 里程碑 · 核心增量）](#e.5-s5-自主-+-操控2-周-6-里程碑-核心增量)
  - [E.6 S6 · 集成 + 收口 + v10.1.1 发布（1 周 · 3 里程碑）](#e.6-s6-集成-+-收口-+-v10.1.1-发布1-周-3-里程碑)
  - [E.7 完整里程碑清单](#e.7-完整里程碑清单)
  - [E.8 任务优先级排序](#e.8-任务优先级排序)
  - [E.9 阶段性里程碑节点](#e.9-阶段性里程碑节点)
  - [E.10 资源需求清单](#e.10-资源需求清单)
  - [E.11 风险与应对策略](#e.11-风险与应对策略)
  - [E.12 关键里程碑总览](#e.12-关键里程碑总览)
- [F · Phase 4 · 风险 / 资源 / 验收](#f-phase-4-风险-/-资源-/-验收)
  - [F.1 不在本次范围（明确边界）](#f.1-不在本次范围明确边界)
  - [F.2 完整 e2e 验收清单](#f.2-完整-e2e-验收清单)
  - [F.3 与现有计划的兼容关系](#f.3-与现有计划的兼容关系)
  - [F.4 最终决策点（请用户确认）](#f.4-最终决策点请用户确认)
- [G · 版本号管理规范（🆕 融合需求）](#g-版本号管理规范-融合需求)
  - [G.1 总则：版本号格式（参考 v9.0 → v10.1.1）](#g.1-总则版本号格式参考-v9.0-v10.1.1)
  - [G.2 版本号变更规则矩阵](#g.2-版本号变更规则矩阵)
  - [G.3 各阶段任务对应的版本号变更（v10.1.1 → 终态路线图）](#g.3-各阶段任务对应的版本号变更v10.1.1-终态路线图)
  - [G.4 触发条件](#g.4-触发条件)
  - [G.5 审批流程](#g.5-审批流程)
  - [G.6 记录要求](#g.6-记录要求)
  - [G.7 版本号变更检查清单（执行前自检 · 强制项）](#g.7-版本号变更检查清单执行前自检-强制项)
  - [G.8 本规范的持续性](#g.8-本规范的持续性)
  - [G.9 完整演进时间线（v10.1.1 → v12.0.1）](#g.9-完整演进时间线v10.1.1-v12.0.1)
  - [G.10 决策点（请用户确认）](#g.10-决策点请用户确认)
- [H · 架构决策：方案 C（单 Agent 对外 + 准多 Agent 内部）🆕](#h-架构决策方案-c单-agent-对外-+-准多-agent-内部)
  - [H.1 多 Agent 在 Aerie 场景的潜在好处（4 个，客观评估）](#h.1-多-agent-在-aerie-场景的潜在好处4-个客观评估)
  - [H.2 Aerie 不推荐&#34;真多 Agent&#34;的 5 个核心理由](#h.2-aerie-不推荐)
  - [H.3 推荐方案 C：单 Agent 对外 + 准多 Agent 内部](#h.3-推荐方案-c单-agent-对外-+-准多-agent-内部)
  - [H.4 三个方案对比](#h.4-三个方案对比)
  - [H.5 什么场景才需要&#34;真多 Agent&#34;？](#h.5-什么场景才需要)
- [I · 为什么不引入 LangChain / AutoGen / CrewAI？🆕](#i-为什么不引入-langchain-/-autogen-/-crewai)
  - [I.1 候选框架评分（4 维）](#i.1-候选框架评分4-维)
  - [I.2 不引入 LangChain 的 5 个理由](#i.2-不引入-langchain-的-5-个理由)
  - [I.3 不引入 AutoGen 的 4 个理由](#i.3-不引入-autogen-的-4-个理由)
  - [I.4 不引入 CrewAI 的 4 个理由](#i.4-不引入-crewai-的-4-个理由)
  - [I.5 自研 vs 第三方 决策矩阵](#i.5-自研-vs-第三方-决策矩阵)
  - [I.6 唯一借鉴的 3 个框架（参考概念 / 思路，不引入依赖）](#i.6-唯一借鉴的-3-个框架参考概念-/-思路不引入依赖)
- [J · 工作流可视化：实时 Trace 编译器 + 专用页面 🆕](#j-工作流可视化实时-trace-编译器-+-专用页面)
  - [J.1 用户需求拆解：3 个层级](#j.1-用户需求拆解3-个层级)
  - [J.2 Trace 编译器设计](#j.2-trace-编译器设计)
  - [J.3 9 阶段 Pipeline 的 Trace 化](#j.3-9-阶段-pipeline-的-trace-化)
  - [J.4 Electron Cognition Panel v2 设计](#j.4-electron-cognition-panel-v2-设计)
  - [J.5 三种触发模式](#j.5-三种触发模式)
  - [J.6 与现有能力的关系](#j.6-与现有能力的关系)
  - [J.7 实施路径](#j.7-实施路径)
  - [J.8 与现有 6 阶段路线图的关系](#j.8-与现有-6-阶段路线图的关系)
  - [J.9 与 §G 版本号管理的关系](#j.9-与-g-版本号管理的关系)
  - [J.10 决策点（请用户确认）](#j.10-决策点请用户确认)
  - [J.11 嵌入主窗口右侧 · 布局设计 + 挤压应对方案（已确认决策 #8）](#j.11-嵌入主窗口右侧-布局设计-+-挤压应对方案已确认决策-#8)
- [K · 已确认决策清单（v10.1.1 主人选定）🆕](#k-已确认决策清单v10.1.1-主人选定)
  - [K.1 10 项已确认决策总览](#k.1-10-项已确认决策总览)
  - [K.2 L4 自进化分级触发详细定义（决策 #5）](#k.2-l4-自进化分级触发详细定义决策-#5)
  - [K.3 电脑操控 3 档权限详细定义（决策 #6）](#k.3-电脑操控-3-档权限详细定义决策-#6)
  - [K.4 QQ 深耕详细方案（决策 #7）](#k.4-qq-深耕详细方案决策-#7)
  - [K.5 实施前最后检查（v10.1.1 → S1 启动）](#k.5-实施前最后检查v10.1.1-s1-启动)
  - [K.6 与 §0 快速恢复的关联](#k.6-与-0-快速恢复的关联)

### [NEW] v10.1.1 Increment Tasks Zone

- [L · 悬浮球 v2 重写说明（仿豆包 · 可自定义外观）🆕](#l-悬浮球-v2-重写说明仿豆包-可自定义外观)
  - [L.1 旧版问题清单](#l.1-旧版问题清单)
  - [L.2 设计目标（v2 · 对齐豆包 + Dify AI 智能体悬浮球）](#l.2-设计目标v2-对齐豆包-+-dify-ai-智能体悬浮球)
  - [L.3 文件改动（3 个文件 · 全部重写）](#l.3-文件改动3-个文件-全部重写)
  - [L.4 关键交互流程（5 个）](#l.4-关键交互流程5-个)
  - [L.5 外观自定义系统](#l.5-外观自定义系统)
  - [L.6 与主进程集成](#l.6-与主进程集成)
  - [L.7 主进程 brand 对齐](#l.7-主进程-brand-对齐)
  - [L.8 验收清单](#l.8-验收清单)
  - [L.9 后续优化（v11.x 路线）](#l.9-后续优化v11.x-路线)
- [Q · Persona 名称动态化（SSOT 化 · 5 步闭环）🆕](#q-persona-名称动态化ssot-化-5-步闭环)
  - [Q.1 现状盘点（5 文件 · 12 处）](#q.1-现状盘点5-文件-12-处)
  - [Q.2 设计原则（SSOT · DRY · 配置驱动）](#q.2-设计原则ssot-dry-配置驱动)
  - [Q.3 实施计划（5 步闭环）](#q.3-实施计划5-步闭环)
  - [Q.4 数据流图（完整闭环）](#q.4-数据流图完整闭环)
  - [Q.5 保留项（不动 · 品牌资产保护）](#q.5-保留项不动-品牌资产保护)
  - [Q.6 风险与边界](#q.6-风险与边界)
  - [Q.7 验证清单（13 项 · 上线前必跑）](#q.7-验证清单13-项-上线前必跑)
  - [Q.8 与已有架构的关系](#q.8-与已有架构的关系)
  - [Q.9 后续优化（v11.x 路线）](#q.9-后续优化v11.x-路线)
  - [Q.10 主人决策清单](#q.10-主人决策清单)

### [APPENDIX] Appendix Zone

- [附录 A · 完整 GitHub 项目清单（52+ 项目）](#附录-a-完整-github-项目清单52+-项目)
- [附录 B · v10.0 / v10.1 / v10.1.1 三版对照表](#附录-b-v10.0-/-v10.1-/-v10.1.1-三版对照表)
- [附录 C · OpenCloud 原始幻想 → Aerie 落地映射](#附录-c-opencloud-原始幻想-aerie-落地映射)
  - [C.1 OpenCloud §21 持续进化机制 → Aerie 4 级自进化](#c.1-opencloud-21-持续进化机制-aerie-4-级自进化)
  - [C.2 OpenCloud §13 工具系统 + §14 高权限 → Aerie 工具族](#c.2-opencloud-13-工具系统-+-14-高权限-aerie-工具族)
  - [C.3 OpenCloud §4.4 主动消息 → Aerie 主动循环](#c.3-opencloud-4.4-主动消息-aerie-主动循环)
- [附录 D · Etta 的最终总结](#附录-d-etta-的最终总结)

### [OPS] Ops / Contact Zone

- [N · 免责声明 ⚠️](#n-免责声明)
  - [N.1 通用免责](#n.1-通用免责)
  - [N.2 AI 生成内容免责](#n.2-ai-生成内容免责)
  - [N.3 自进化（L4）特殊风险](#n.3-自进化l4特殊风险)
  - [N.4 电脑操控（S5）特殊风险](#n.4-电脑操控s5特殊风险)
  - [N.5 数据隐私免责](#n.5-数据隐私免责)
  - [N.6 责任划分](#n.6-责任划分)
  - [N.7 适用法律](#n.7-适用法律)
- [O · 用户须知 📋](#o-用户须知)
  - [O.1 最低运行要求](#o.1-最低运行要求)
  - [O.2 首次启动](#o.2-首次启动)
  - [O.3 关键路径速查](#o.3-关键路径速查)
  - [O.4 常用命令](#o.4-常用命令)
  - [O.5 常见问题](#o.5-常见问题)
  - [O.6 安全建议](#o.6-安全建议)
  - [O.7 升级流程](#o.7-升级流程)
...
- [P · 联系方式 💌](#p-联系方式)
  - [P.1 联系方式](#p.1-联系方式)
  - [P.2 什么时候联系](#p.2-什么时候联系)
  - [P.3 什么时候**不**紧急](#p.3-什么时候**不**紧急)
  - [P.4 联系示例](#p.4-联系示例)
  - [P.5 隐私承诺](#p.5-隐私承诺)
