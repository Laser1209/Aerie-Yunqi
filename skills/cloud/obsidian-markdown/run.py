"""obsidian-markdown skill (cloud) — Obsidian Markdown / Obsidian MD.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'content'."""
    args = args or {}
    content_value = args.get("content")
    if not content_value:
        return {"error": "missing content", "provider_hint": PROVIDER_HINT}
