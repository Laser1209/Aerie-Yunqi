"""volcengine-tos skill (cloud) — 火山引擎对象存储 / TOS.

Block-5B scaffold. Cloud-based skill that requires external
credentials (env: `TOS_AK`). When the env var is
