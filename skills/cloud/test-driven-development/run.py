"""test-driven-development skill (cloud) — TDD / Test-driven.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'feature'."""
    args = args or {}
    feature_value = args.get("feature")
    if not feature_value:
        return {"error": "missing feature", "provider_hint": PROVIDER_HINT}
