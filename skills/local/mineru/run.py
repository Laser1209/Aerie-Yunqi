"""mineru skill — PDF/文档解析 / Document parse.

Block-4C R3.3 scaffold. Tries to call the native module
``local_mineru`` when it is importable; otherwise returns a stub
...
def run(args: dict) -> dict:
    ...
    try:
        from local_mineru import parse as _impl
    except ImportError as e:
        return {
            "status": "stub",
            "error": f"local_mineru not installed: {e}",
    ...
    try:
        ...
        logger.exception("mineru skill failed")
