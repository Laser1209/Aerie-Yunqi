"""vercel-composition skill (cloud) — Vercel 组合模式 / Vercel composition.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'code'."""
    args = args or {}
    code_value = args.get("code")
    if not code_value:
        return {"error": "missing code", "provider_hint": PROVIDER_HINT}
