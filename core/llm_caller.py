...
# LLMCaller.generate_push splices into the LLM system message.
...
# Block-4C R3.5: Multi-provider entry points (mixed into the LLMCaller
...
# Mix the new methods into the existing LLMCaller class (monkey patch).
LLMCaller._load_ai_options = _brain_load_ai_options
LLMCaller.get_ai_options = _brain_get_ai_options
LLMCaller.bge_embed = _brain_bge_embed
LLMCaller.generate_image = _brain_generate_image
LLMCaller.generate_image_edit = _brain_generate_image_edit
LLMCaller.speak_text = _brain_speak_text
LLMCaller.see_image = _brain_see_image
LLMCaller.safe_shell = _brain_safe_shell
