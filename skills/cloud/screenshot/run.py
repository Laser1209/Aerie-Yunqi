"""screenshot skill (cloud) — 系统截图 / Screenshot.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'region'."""
    args = args or {}
    region_value = args.get("region")
    if not region_value:
        return {"error": "missing region", "provider_hint": PROVIDER_HINT}
