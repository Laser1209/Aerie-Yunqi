"""Aerie · 云栖 v9.0 — OpenAI proxy provider (api.codexgood.com).

Available models: gpt-5.5 / gpt-5.6-luna / gpt-5.6-sol / gpt-5.6-terra.
"""
...
class OpenAIProxyProvider(Provider):
    name = "openai_proxy"
