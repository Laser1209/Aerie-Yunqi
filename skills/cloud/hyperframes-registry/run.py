"""hyperframes-registry skill (cloud) — HyperFrames 块注册 / HF registry.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'block'."""
    args = args or {}
    block_value = args.get("block")
    if not block_value:
        return {"error": "missing block", "provider_hint": PROVIDER_HINT}
