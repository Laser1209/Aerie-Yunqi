"""web-artifacts-builder skill (cloud) — 复杂 artifact 构建 / Web artifacts.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'spec'."""
    args = args or {}
    spec_value = args.get("spec")
    if not spec_value:
        return {"error": "missing spec", "provider_hint": PROVIDER_HINT}
