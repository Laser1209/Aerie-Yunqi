"""doc-coauthoring skill (cloud) — 文档协作 / Doc coauthoring.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'draft'."""
    args = args or {}
    draft_value = args.get("draft")
    if not draft_value:
        return {"error": "missing draft", "provider_hint": PROVIDER_HINT}
