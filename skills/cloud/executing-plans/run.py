"""executing-plans skill (cloud) — 执行计划 / Executing plans.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'plan_id'."""
    args = args or {}
    plan_id_value = args.get("plan_id")
    if not plan_id_value:
        return {"error": "missing plan_id", "provider_hint": PROVIDER_HINT}
