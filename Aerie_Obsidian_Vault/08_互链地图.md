...
| [[modules/QQMediaPipeline|QQ 多媒体管道]] | [[modules/QQMediaPipeline#4. 关键文件 / 实现入口]] | [[dependencies/Internal-Attachment-Pipeline]] | 每层独立降级，不阻塞主回复 | [[06_验证索引#P0-功能验证]] |
| [[modules/ChatPhotoTriggerChain|Chat 出图触发链]] | [[modules/ChatPhotoTriggerChain#链路总览]] | [[modules/VisualIntentRouter]]、[[modules/ImageObservation]] | R-TC-003、R-TC-008 | [[06_验证索引#P0-功能验证]] |
...
- [x] 每个页面都有返回首页路径。
- [x] 每个审计发现都有验证项（含 AUD-0201~0204 回链 P0 验证）。
- [x] 每个验证项都有证据入口。
- [x] 每个关键技术取舍都有 ADR。
- [x] 每个依赖风险都有维护策略。
- [x] 核心概念均已建立实现、依赖、风险/决策、验证四类链接（含新增 [[modules/ChatPhotoTriggerChain|ChatPhotoTriggerChain]]、[[modules/QQMediaPipeline|QQMediaPipeline]]）。
