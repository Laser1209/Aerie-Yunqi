"""shadcn skill (cloud) — shadcn/ui 组件 / shadcn.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'component'."""
    args = args or {}
    component_value = args.get("component")
    if not component_value:
        return {"error": "missing component", "provider_hint": PROVIDER_HINT}
    ...
    if not True  # 无需凭据:
        return {
            ...
            "read_only": READ_ONLY,
            "component": str(component_value)[:80],
        }
