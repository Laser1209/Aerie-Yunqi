"""brainstorming skill (cloud) — 需求探索 / Brainstorming.
...
def run(args: dict) -> dict:
    """Skill entry point. ``args`` is a free-form dict; key: 'intent'."""
    args = args or {}
    intent_value = args.get("intent")
    if not intent_value:
        return {"error": "missing intent", "provider_hint": PROVIDER_HINT}
