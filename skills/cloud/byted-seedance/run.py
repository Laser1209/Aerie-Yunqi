"""byted-seedance skill (cloud) — Seedance 文生视频 / Seedance video.

Block-5B scaffold. Cloud-based skill that requires external
credentials (env: `SEEDANCE_KEY`). When the env var is
