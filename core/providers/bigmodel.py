"""Aerie · 云栖 v9.0 — BigModel / Zhipu GLM provider (OpenAI-compatible)."""
...
class BigModelProvider(Provider):
    """Zhipu GLM provider via BigModel platform (open.bigmodel.cn)."""
    ...
    def __init__(
        ...
        model = model or os.getenv("BIGMODEL_MODEL", "glm-4-plus")
